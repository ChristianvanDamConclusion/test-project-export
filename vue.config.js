...
const allRoutes = ["/login","/signup","/reset-password","/post_google_oauth_redirect_page","/contacts","/user-management","/forgot-password","/companies","/"];
            ...
            new PrerenderSPAPlugin({
                ...
                postProcess(renderedRoute) {
                    ...
                    if (match && match[1]) {
                        ...
                        // eslint-disable-next-line no-undef
                        const scripts = {"head":{},"body":{},"globalBody":null};
