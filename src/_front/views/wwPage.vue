...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            hoverObject: 'manager/getHoverObject',
            hoverSection: 'manager/getHoverSection',
        }),
        nbObjects() {
            return Object.keys(this.$store.state.websiteData.wwObjects).length;
        },
    },
    watch: {
        activeLinkPopup() {
    ...
    methods: {
        ...
        getDisableHydration(section) {
            ...
            if (window.__WW_IS_PRERENDER__) return false;
