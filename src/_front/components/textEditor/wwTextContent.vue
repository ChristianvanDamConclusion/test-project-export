...
export default {
    ...
    render() {
        ...
        if (this.links && Object.keys(this.links).length) {
            ...
            return h(this.tag, { class: { 'ww-text-content': true, editing: this.isEditing } }, children);
        } else {
            return h(this.tag, { class: { 'ww-text-content': true, editing: this.isEditing }, innerHTML: text });
        }
    },
};
</script>
