...
import { evaluateCode, evaluateFormula } from '@/_common/helpers/code/customCode';
...
export default {
    useFormula() {
        ...
        const resolveMappingFormula = (formula, mappingContext = null, defaultValue = null) => {
            ...
            try {
                const result = evaluate({ code: _formula.code }, { mapping: mappingContext, ...bindingContext });
                return result.value;
            } catch (error) {
                return defaultValue;
            }
