...
export default {
    ...
    setVariableValue({ commit }, { variableId, value, ignoreQuery, path, index, arrayUpdateType }) {
        commit('setVariableValue', { variableId, value, ignoreQuery, path, index, arrayUpdateType });
    },
    // Formulas
